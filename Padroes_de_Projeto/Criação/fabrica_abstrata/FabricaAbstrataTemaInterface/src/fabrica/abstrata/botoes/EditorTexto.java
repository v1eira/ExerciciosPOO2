...
public class EditorTexto extends javax.swing.JFrame {
    ...
    private void addButtons(String tema){
        ...
        FabricaAbstrataBotoes botoesTema = null;
        
        if(tema.equalsIgnoreCase("tema1")){
            botoesTema = new FabricaPadrao();
        }else if(tema.equalsIgnoreCase("tema2")){
            botoesTema = new FabricaBotoesIcones();
        }
        
        //botoesTema.criaBotaoCancel();
        //botoesTema.criaBotaoOK();
        
        cancel = botoesTema.criaBotaoCancel();
        ok = botoesTema.criaBotaoOK();
        ok.setText("OK");
        cancel.setText("Cancelar");
        
        //cancel.setSize(2000, 2000);
